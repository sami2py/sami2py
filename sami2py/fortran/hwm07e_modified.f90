...
subroutine hwm07(iyd,sec,alt,glat,glon,stl,f107a,f107,ap,w)
    ...
    call hwmqt07(iyd,sec,alt,glat,glon,stl,f107a,f107,ap,qw)
...
subroutine hwmqt07(IYD,SEC,ALT,GLAT,GLON,STL,F107A,F107,AP,W)
...
! ====================================================================
    ...
    if (input(5) .ne. last(5)) then
        call vertwght07(input(5),zwght,lev)
        last(5) = input(5)
    endif
...
subroutine vertwght07(alt,wght,iz)
